...
type
  TField = Array[-50..50, -50..50] of Single;//высота
...
begin
  ...
  //текстурирование
  if frmOptions.cbTexturing.Checked then
...
begin
  ...
  LoadTexture('data\textures\skybox_a.dat', 1, 2);
  LoadTexture('data\textures\skybox_a.dat', 2, 3);
  LoadTexture('data\textures\skybox_a.dat', 3, 4);
  LoadTexture('data\textures\skybox_a.dat', 4, 5);
  LoadTexture('data\textures\skybox_a.dat', 5, 6);
  LoadTexture('data\textures\skybox_a.dat', 6, 7);
